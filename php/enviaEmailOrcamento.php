...
$nomeremetente     = $_POST['ceco_nome_contato'];
$telefoneContato   = $_POST['ceco_telefone'];
$email             = $_POST['ceco_email'];
$cep               = $_POST['ceco_cep'];
$bairro            = $_POST['ceco_bairro'];
$logradouro        = $_POST['ceco_logradouro'];
$NResidencia       = $_POST['ceco_numero'];
...
$mensagemHTML = "Este contato solicita que seja verificado a disponibilidade de nossos serviços em sua residência. \n\n";
...
$mensagemHTML .= "Bairro $bairro \n";
$mensagemHTML .= "Logradouro: $logradouro \n";
$mensagemHTML .= "Nº residência: $NResidencia \n";

if (isset($_POST['ceco_contato_whats']) && $_POST['ceco_contato_whats'] == 'on') {
